...
class SupplierView:
    ...
    def give_frame(cls, app_: CTk) -> CTkFrame:
        ...
        # =========== TITULO STOCK ===========
        CTkLabel(
                master=title_frame, text='Fornecedor', font=('Verdana', 30), text_color='#045A87').pack(anchor='nw',
                                                                                                        side='left')

        # Add novos produtos
        CTkButton(master=title_frame, text="+ Novo Fornecedor", font=("Verdana", 15), text_color="#fff",
        ...
        CTkEntry(master=search_container, width=305, placeholder_text="Pesquise o Fornecedor", border_color="#008DD2",
