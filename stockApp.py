...
class StockView:
    ...
    def sidebar(cls):
        ...
        cls.sidebar_frame = CTkFrame(master=cls.app, fg_color="#008DD2",  width=176, height=650, corner_radius=0)
    ...
    def list_stock(cls):
        ...
        cls.table = CTkTable(master=cls.table_frame, values=cls.table_data, colors=["#E6E6E6", "#EEEEEE"], header_color="#008DD2", hover_color="#B4B4B4")
