...
class DescriptionProduct:
    ...
    def create_form_products(cls, label, variable): 
        ...
        ent = Entry(master=container, textvariable=variable, bg="white", relief="solid", borderwidth= 0.5, state=DISABLED)
    ...
    def textbox_description_prod(cls):
        ...
        ent_description = ttk.ScrolledText(master=container, wrap=WORD, height=5, state=DISABLED, relief="solid", borderwidth= 3)
