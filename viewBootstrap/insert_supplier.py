...
class InsertSupplier:
    ...
    def frame_photo_supplier(cls):
        ...
        img_supplier = Image.open(PATH / "fornecedor.png")
        cls.img_supplier = ImageTk.PhotoImage(img_supplier.resize((250, 250)))
        cls.button1 = Label(
            prod_frame_description, width=250, height=250, image=cls.img_supplier, text=""
