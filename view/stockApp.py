...
class StockView:
    ...
    def list_stock(cls):
        ...
        cls.main_view = CTkFrame(
            master=cls.app, fg_color="#fff", width=680, height=650, corner_radius=0
        )
        ...
        cls.table_frame = CTkScrollableFrame(
            master=cls.main_view, fg_color="transparent"
        )
