...
class AppCreateSupplier:
    ...
    def description_frames_supplier(cls) -> CTkFrame:
        ...
        cls.prod_frame = ctk.CTkFrame(
            cls.app_create_supplier, width=350, height=650, fg_color="white"
        )
        ...
        cls.photo_bd_frame = CTkFrame(
            master=cls.prod_frame, fg_color="#045A87", width=350, height=350
        )
        ...
        cls.desc_frame = ctk.CTkFrame(
            cls.app_create_supplier, width=1400, fg_color="#E1E1E1"
        )
        ...
        cls.frame_phone_description = CTkFrame(
            master=cls.desc_frame_uni,
            fg_color="#E1E1E1",
            width=500,
            height=40,
        ...
        # FRAME PARA O EMAIL
        cls.frame_email_description = CTkFrame(
            master=cls.desc_frame_uni,
            fg_color="#E1E1E1",
            width=500,
            height=40,
    ...
    def create_supplier_info(cls):
        ...
        # COLOCANDO A IMAGEM
        cls.prod_img = Image.open("./assets/fornecedor.png")  # PEGAR NO BANCO DE DADOS
    ...
    def create_supplier(cls):
        ...
        cls.entry_address = CTkEntry(
            cls.frame_address, fg_color="white", width=500, height=30, corner_radius=0
        )
