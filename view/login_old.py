...
class LoginView:
    ...
    def sidebar(cls):
        ...
        cls.sidebar_frame = CTkFrame(master=cls.login_app, fg_color="#008DD2",  width=176, height=650, corner_radius=0)
        ...
        CTkButton(master=cls.sidebar_frame, image=cls.stock_img, text="Stock", fg_color="transparent", font=("Verdana", 14), hover_color="#045A87", anchor="w").pack(anchor="center", ipady=5, pady=(16, 0))
    ...
    def login_view(cls):
        ...
        frame = CTkFrame(master=cls.login_app, width=300, height=480, fg_color="#ffffff")
        ...
        CTkLabel(master=frame, text="", image=cls.logo_img).pack(pady=(20, 0), anchor="center")
        

        # Mensagem boas vindas - login
        CTkLabel(master=frame, text="Entre!", text_color="#045A87", anchor="w", justify="left", font=("Arial Bold", 24)).pack(anchor="w", pady=(5, 5), padx=(25, 0))
        ...
        #Entrada Email
        cls.txt_email = CTkLabel(master=frame, text="Email:", text_color="#045A87", anchor="w", justify="left", font=("Arial Bold", 14), compound="left").pack(anchor="w", pady=(5, 0), padx=(25, 0)) 
        # Entrada para por o email
        cls.email_entry = CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#045A87", border_width=1, text_color="#000000").pack(anchor="w", padx=(25, 0))
        
        #Entrada para por a password
        cls.txt_pass = CTkLabel(master=frame, text="Password:", text_color="#045A87", anchor="w", justify="left", font=("Arial Bold", 14), compound="left").pack(anchor="w", pady=(21, 0), padx=(25, 0))
        cls.pass_entry = CTkEntry(master=frame, width=225, fg_color="#EEEEEE", border_color="#045A87", border_width=1, text_color="#000000", show="*").pack(anchor="w", padx=(25, 0))
