...
class AppDescription:
    ...
    def img_products(cls):
        ...
        cls.prod_img = CTkImage(
            dark_image=cls.prod_img, light_image=cls.prod_img, size=(250, 250)
        )
    ...
    def description_products(cls):
        ...
        # Descricao
        cls.details_label = CTkLabel(
            cls.desc_frame,
            text="Dina, 47 cl, 6 unidades\nDesconto de quantidade\nOferta\n• Marca: METRO Professional\n• Capacidade: 47 cl\n• Forma clássica\n• Lavável na máquina de lavar louça\n• Altura: 21.9 cm\n• Conjunto composto por 6 copos",
            justify="left",
            font=("Verdana", 14),
        )
