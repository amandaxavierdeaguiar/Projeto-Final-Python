...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.VARCHAR(), autoincrement=False, nullable=False, unique=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('supplier_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["supplier_id"], ["supplier.id"], name="brand_supplier_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('product_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column(
            "bar_cod", sa.VARCHAR(), autoincrement=False, nullable=False, unique=True
        ),
        sa.Column("name", sa.VARCHAR(), autoincrement=False, nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["category.id"], name="product_category_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["brand_id"], ["brand.id"], name="product_brand_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product_id"], ["product.id"], name="stock_product_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column(
            "login", sa.VARCHAR(), autoincrement=False, nullable=False, unique=True
        ),
        sa.Column("password", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column("name", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column(
            "typeAccess",
            postgresql.ENUM("Admin", "User", name="typeaccess"),
            autoincrement=False,
            nullable=False,
        ),
